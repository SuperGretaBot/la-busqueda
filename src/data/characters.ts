...
export const characters: Character[] = [
  ...
  { id: 'hp-02', name: 'Hermione Granger',       category: 'hp', image: '/characters/hp/hermione.png',     emoji: '📚' },
  ...
  { id: 'hp-05', name: 'Severus Snape',          category: 'hp', image: '/characters/hp/hermione2.png',    emoji: '🧪' },
  { id: 'hp-06', name: 'Rubeus Hagrid',          category: 'hp', image: '/characters/hp/hagrid.png',       emoji: '🪄' },
  { id: 'hp-07', name: 'Draco Malfoy',           category: 'hp', image: '/characters/hp/draco.png',        emoji: '🐍' },
  { id: 'hp-08', name: 'Luna Lovegood',          category: 'hp', image: '/characters/hp/luna.png',         emoji: '🌙' },
  ...
  { id: 'hp-15', name: 'Dean Thomas',            category: 'hp', image: '/characters/hp/dean-thomas.png',  emoji: '⚽' },
